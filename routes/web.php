...
Route::get('/recipe/step2/{id}', 'MaterialController@step2')->name('recipe.step2');
Route::post('/recipe/material_store', 'MaterialController@material_store')->name('recipe.material_store');
...
Route::get('/recipe/matrial_edit/{recipe_id}', 'MaterialController@material_edit');
Route::post('/recipe/matrial_update/', 'MaterialController@material_update')->name('recipe.material_update');
Route::get('/recipe/process_edit/{recipe_id}', 'RecipeController@process_edit');
Route::post('/recipe/process_update/', 'RecipeController@process_update')->name('recipe.process_update');
